...
const FOUNDING_URL = 'mailto:rukiyah@rukiyahpolk.com?subject=4-Week%20Experience%20Enrollment'; // 4-Week Experience enrollment interest link
...
(() => {
  ...
  const answers = {
    compare: `If you have one clear money problem you want help with, start with the $247 Money Behavior Strategy™ Session. If the same money patterns keep showing up and you want four weeks to test changes in real life, look at the 4-Week Experience. <a href="${workLink}#compare">Compare both options →</a>`,
    ...
    founding: `The 4-Week Experience is four weeks of private, virtual work for repeating money patterns. You move through SEE → ASK WHY → TRY → MAKE A PLAN and build My Money Playbook™. The 4-Week Experience price is $597. <a href="${workLink}#founding">See the 4-week experience →</a>`,
    afterpay: `After you pay, you receive confirmation and the next steps for your offer. For the 4-Week Experience, the website also has a welcome flow with your Starting Point and what happens before Week 1. If anything is unclear, use the human-support link below.`,
    binder: `The Mini Money Binder is included with the 4-Week Experience. It holds your observations, practice pages, 70/10/10/10 work, and My Money Playbook™ — a hands-on companion to the experience, not the Money Behavior Strategy™ method itself.`,
